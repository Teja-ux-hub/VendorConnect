              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-gray-600">I sell street food and need suppliers</div>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-sm text-gray-600">I supply raw materials to vendors</div>
                  </div>
                </button>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  {formData.location.address && (
                    <p className="text-sm text-green-600">📍 {formData.location.address}</p>
                  )}
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Your vendor profile is ready. Start finding suppliers near you!
                </p>
              </div>
