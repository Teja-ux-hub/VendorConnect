...
export default function SellerOrdersPage() {
  ...
  const { user, orders, updateOrderStatus } = useStoree()
  ...
  const rejectedOrders = sellerOrders.filter(o => o.status === 'cancelled')
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md">
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-xl font-semibold">All Orders ({sellerOrders.length})</h2>
          </div>
          ...
          <div className="divide-y divide-gray-200">
            {sellerOrders.length > 0 ? (
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          {order.status === 'accepted' && (
                            <div>
                              <h4 className="font-medium text-gray-900 mb-1">Vendor Contact:</h4>
                      ...
                      {order.status === 'accepted' && (
                        <div className="text-center space-y-2">
                          ...
                          <a
                            ...
                            className="btn-secondary inline-flex items-center space-x-2 mb-2"
                          >
                          ...
                          <button
                            ...
                            className="block w-full bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg font-medium"
                          >
                            Mark Complete
                          </button>
                        </div>
              ...
              <div className="p-12 text-center">
                ...
                <p className="text-gray-600 mb-4">Orders from vendors will appear here once they start placing orders.</p>
                <button
